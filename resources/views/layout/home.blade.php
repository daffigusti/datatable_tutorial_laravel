...
<head>
    ...
    <!-- iCheck -->
    <link href="{{url("")}}/plugins/iCheck/skins/flat/green.css" rel="stylesheet">
    <!-- bootstrap-progressbar -->
    <link href="{{url("")}}/plugins/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- jVectorMap -->
    <link href="{{url("")}}/css/maps/jquery-jvectormap-2.0.3.css" rel="stylesheet"/>
                        ...
                        <ul class="nav side-menu">
                            <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    ...
                                    <li><a href="{{action("TableController@getIndex")}}">Table</a>
                                    </li>
                                    </li>
                                </ul>
                            </li>
...
<!-- Chart.js -->
<script src="{{url("")}}/plugins/Chart.js/dist/Chart.min.js"></script>
<!-- gauge.js -->
<script src="{{url("")}}/plugins/bernii/gauge.js/dist/gauge.min.js"></script>
<!-- bootstrap-progressbar -->
<script src="{{url("")}}/plugins/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
<!-- iCheck -->
<script src="{{url("")}}/plugins/iCheck/icheck.min.js"></script>
<!-- Skycons -->
<script src="{{url("")}}/plugins/skycons/skycons.js"></script>
<!-- Flot -->
<script src="{{url("")}}/plugins/Flot/jquery.flot.js"></script>
<script src="{{url("")}}/plugins/Flot/jquery.flot.pie.js"></script>
<script src="{{url("")}}/plugins/Flot/jquery.flot.time.js"></script>
<script src="{{url("")}}/plugins/Flot/jquery.flot.stack.js"></script>
<script src="{{url("")}}/plugins/Flot/jquery.flot.resize.js"></script>
<!-- Flot plugins -->
<script src="{{url("")}}/js/flot/jquery.flot.orderBars.js"></script>
<script src="{{url("")}}/js/flot/date.js"></script>
<script src="{{url("")}}/js/flot/jquery.flot.spline.js"></script>
<script src="{{url("")}}/js/flot/curvedLines.js"></script>
<!-- jVectorMap -->
<script src="{{url("")}}/js/maps/jquery-jvectormap-2.0.3.min.js"></script>
